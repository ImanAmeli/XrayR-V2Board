...
install_XrayR() {
    ...
    # 输入域名（TLS）
    echo "输入你的域名"
    echo "wget https://cdn.jsdelivr.net/gh/ImanAmeli/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml"
    ...
    # 写入配置文件
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/ImanAmeli/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
